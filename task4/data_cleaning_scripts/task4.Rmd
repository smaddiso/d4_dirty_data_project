...
candy_all_years_clean <- candy_all_years_clean[!grepl("person_of_interest_season_3_dvd_box_set_not_including_disc_4_with_hilarious_outtakes", candy_all_years_clean$candy),]

candy_all_years_clean <- candy_all_years_clean[!grepl("real_housewives_of_orange_county_season_9_blue_ray", candy_all_years_clean$candy),]
```
